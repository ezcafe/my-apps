...
const inputCls =
  "min-w-0 flex-1 border-0 bg-transparent px-4 py-3 text-base text-foreground tabular-nums antialiased outline-none placeholder:text-muted disabled:cursor-not-allowed disabled:opacity-45";
