...
type InvestmentSectionTabIconId = "overview" | "activities" | "new" | "settings";
...
const tabs: Array<{
  href: string;
  label: string;
  icon: InvestmentSectionTabIconId;
  exact: boolean;
}> = [
  { href: "/investment", label: "Overview", icon: "overview", exact: true },
  {
  ...
  { href: "/investment/new", label: "New", icon: "new", exact: false },
  {
...
export function InvestmentSectionTabs() {
