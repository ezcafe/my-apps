...
describe("chrome paths", () => {
  it("treats money, investments, loans, baby, kiosk, and core routes as in-page chrome", () => {
    ...
    assert.equal(hidesShellRailChrome("/baby"), true);
    assert.equal(hidesShellRailChrome("/baby/feed"), true);
